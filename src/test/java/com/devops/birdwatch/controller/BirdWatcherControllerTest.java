...
public class BirdWatcherControllerTest {
  ...
  public void testGetAllBirdWatchers() throws Exception {
    ...
    when(birdWatcherService.getAllBirdWatchers()).thenReturn(
        new ResponseEntity<>(birdWatchers, HttpStatus.OK));
  ...
  public void testAddBirdWatcher() throws Exception {
    ...
    when(birdWatcherService.addBirdWatcher(birdWatcher)).thenReturn(
        new ResponseEntity<>(savedBirdWatcher, HttpStatus.CREATED));
  ...
  public void testDeleteBirdWatcher() throws Exception {
    ...
    when(birdWatcherService.deleteBirdWatcher(id)).thenReturn(
        new ResponseEntity<>("BirdWatcher with id 1 deleted", HttpStatus.OK));
